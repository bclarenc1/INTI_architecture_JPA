...
public class DaoImpl implements Idao {
	...
	public int supprimerPersonne(Personne p) {
		...
		try {
			tx.begin();
			System.out.println("sloubi 2");
			em.remove(p);
			System.out.println("sloubi 3");
			tx.commit();
			em.close();
			emf.close();
...
//		
//		try {
//			q = em.createQuery("select a from Adresse a where nomRue like :var");
////			q = em.createQuery("select a from Adresse a where :field like lower(concat('%',:var,'%'))");
